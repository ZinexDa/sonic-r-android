...
{
#ifdef __ANDROID__
    static int s_loggedFade = 999;
    if (g_fadeLevel != s_loggedFade) {
        __android_log_print(ANDROID_LOG_INFO, "SonicR-Fade", "RenderFadeOverlay: fadeLevel=%d, fadeState=%d", g_fadeLevel, g_fadeState);
        s_loggedFade = g_fadeLevel;
    }
#endif
