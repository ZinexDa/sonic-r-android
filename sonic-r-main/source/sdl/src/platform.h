...
/* High-resolution diagnostic timer */
uint64_t GetTimeNs(void);
extern uint64_t g_perfLogicNs;
extern uint64_t g_perfWaitCapNs;
...
/* Raw controller buttons for menu/lobby screens the keyboard-era UI never
